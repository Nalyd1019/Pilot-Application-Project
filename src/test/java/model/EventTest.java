...
public class EventTest {
    ...
    private Event event = new Event(LocalDate.now(), 12, 1, "Test event");
    ...
    private FlyingEvent flyingEvent = new FlyingEvent(LocalDate.now(), 12, 14, "Test event", airplanes);
    private FlyingEvent flyingEvent2 = new FlyingEvent(LocalDate.now(), 9, 13, "Test event", airplanes);
